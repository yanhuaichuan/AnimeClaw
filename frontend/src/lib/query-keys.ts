...
export const queryKeys = {
  ...
  animeCatalog: () => ["anime", "catalog"] as const,
  animeWorld: (p: string) => ["projects", p, "anime", "world"] as const,
  animeStyle: (p: string) => ["projects", p, "anime", "style"] as const,
  animeCharacters: (p: string) => ["projects", p, "anime", "characters"] as const,
  animeScenes: (p: string) => ["projects", p, "anime", "scenes"] as const,
  animeEpisode: (p: string, ep: number) =>
    ["projects", p, "anime", "episodes", ep] as const,
  animeQA: (p: string, ep: number) =>
    ["projects", p, "anime", "episodes", ep, "qa"] as const,
  animePreview: (p: string, ep: number) =>
    ["projects", p, "anime", "episodes", ep, "preview"] as const,
  animeCost: (p: string, ep: number, tier: string) =>
    ["projects", p, "anime", "episodes", ep, "cost", tier] as const,
};
