...
const faqs = [
  {
    question: "AnimeClaw 和普通 AI 视频生成工具有什么区别？",
    answer:
      "普通工具通常围绕一次提示词、一个片段或一张图工作。AnimeClaw 面向的是完整项目：从文本导入、资产沉淀、剧集规划、镜头制作到合成导出，形成可追踪、可协作、可复用的生产闭环。",
  },
  {
    question: "第一次使用应该从哪里开始？",
    answer:
      "建议先走主线工作流：漫料导入文本，漫塘确认角色/场景/道具/声线，漫镜规划剧集并生成脚本和镜头，最后进入合成页导出成片。第一次目标不是做完美，而是先跑通一集。",
  },
  {
    question: "漫镜和漫画分别适合做什么？",
    answer:
      "漫镜是主生产线，适合批量、稳定、按剧集推进；漫画是导演工作台，适合关键镜头精修、多版本探索、资产定稿和复杂视频处理。正式项目通常是普通镜头走漫镜，难镜头进漫画。",
  },
  {
    question: "漫画里的结果会自动覆盖主线资产吗？",
    answer:
      "不会。漫画里的生成或上传内容默认是候选结果。只有明确点击写回，并选择角色、场景、道具、Beat 草图、首帧或视频等目标槽位后，结果才会进入正式项目主线。",
  },
  {
    question: "为什么要先整理角色、场景、道具和声线？",
    answer:
      "AI 视频创作最容易返工的原因，往往不是最后一步视频生成，而是前面的角色不稳定、场景不清楚、道具缺参考、声线没统一。漫塘把这些内容先变成资产，可以显著减少后续镜头阶段的混乱。",
  },
  {
    question: "AnimeClaw 适合哪些内容类型？",
    answer:
  ...
  {
    question: "什么是 “Make Your AC Universe.”？",
    answer:
      "AC 不只是 AnimeClaw 的缩写，也代表每个创作者自己的内容宇宙。AnimeClaw 希望帮助创作者从一个故事开始，逐步建立角色、世界观、场景资产和系列化内容生产能力。",
  },
  {
    question: "登录后我会进入哪里？",
    answer:
